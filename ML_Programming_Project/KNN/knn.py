...
class KNN:
    ...
    def get_k_neighbors(self, point):
        ...
        for i in range(len(self.features)):
            ...
            nearestNeighbours.append((distance, self.labels[i]))
        nearestNeighbours.sort(key=lambda y: y[0])
        knn_labels = []
        for i in range(self.k):
            knn_labels.append(nearestNeighbours[i][1])
        return knn_labels
        raise NotImplementedError
    ...
    def predict(self, features):
        ...
        for point in features:
            ...
            predictedLabels.append(most_common)
